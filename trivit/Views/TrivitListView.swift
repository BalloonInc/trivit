...
private let exampleTrivitNameKeys = [
    ...
    "Times I said 'wow'",
    "Cookies in my tummy",
    "Silly dances performed",
    "Dad jokes survived",
    "Pillows fluffed",
    "Socks matched",
    "Clouds that look like animals",
    "Times the dog wagged its tail",
    "Sneezes today",
    "Yawns caught from others",
    "High fives given",
    "Bubbles blown",
    "Puddles jumped in",
    "Funny faces made",
    "Songs sung in shower",
    "Times I forgot why I walked into a room",
    "Dinosaur facts learned",
    "Cards stacked before falling",
    "Grapes caught in mouth",
    "Paper airplanes launched",
